...
CREATE TABLE Culturas (id number(10) GENERATED AS IDENTITY, data_inicial timestamp(0) NOT NULL, data_final timestamp(0), quantidade float(5) NOT NULL, unidades varchar2(50) NOT NULL, exploracao_agricola_id number(10) NOT NULL, planta_id number(10) NOT NULL, PRIMARY KEY (id));
...
ALTER TABLE Culturas ADD CONSTRAINT FKCulturas846845 FOREIGN KEY (exploracao_agricola_id) REFERENCES ExploracaoAgricola (id);
