...
CREATE TABLE Operacoes (id number(10) GENERATED AS IDENTITY, operacao varchar2(50) NOT NULL, modo varchar2(50), data timestamp(0) NOT NULL, quantidade float(5), unidades varchar2(50), fator_producao_id number(10), exploracao_agricula_id number(10) NOT NULL, planta_id number(10) NOT NULL, PRIMARY KEY (id));
