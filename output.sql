...
BEGIN
  ...
  INSERT INTO FATOR_PRODUCAO (
    ...
    'Fitofarmaco',
    'Fungicida'
  ) RETURNING INTO V_ID_FATOR_PRODUCAO;
  ...
  WHERE
    ...
    AND P.NOME='Amarelo'INSERT INTO CULTURA (PARCELA_ID, PLANTA_ID, DATA_INICIAL, DATA_FINAL, QUANTIDADE, UNIDADES) VALUES ('101', V_ID_PLANTA, TIMESTAMP '2020-10-10 00:00:00', 'DATE '2021-03-30'') RETURNING ID INTO V_ID_CULTURA;
  SELECT
    P.ID INTO V_ID_PLANTA
  FROM
    PLANTA P
  ...
  WHERE
    TP.DESIGNACAO='Milho'
    AND P.NOME='Doce Golden Bantam'INSERT INTO CULTURA (PARCELA_ID, PLANTA_ID, DATA_INICIAL, DATA_FINAL, QUANTIDADE, UNIDADES) VALUES ('101', V_ID_PLANTA, TIMESTAMP '2021-04-10 00:00:00', 'DATE '2021-08-12'') RETURNING ID INTO V_ID_CULTURA;
  SELECT
    P.ID INTO V_ID_PLANTA
  FROM
    PLANTA P
  ...
  WHERE
    TP.DESIGNACAO='Tremoco'
    AND P.NOME='Amarelo'INSERT INTO CULTURA (PARCELA_ID, PLANTA_ID, DATA_INICIAL, DATA_FINAL, QUANTIDADE, UNIDADES) VALUES ('101', V_ID_PLANTA, TIMESTAMP '2021-10-03 00:00:00', 'DATE '2022-04-05'') RETURNING ID INTO V_ID_CULTURA;
  SELECT
    P.ID INTO V_ID_PLANTA
  FROM
    PLANTA P
  ...
  WHERE
    TP.DESIGNACAO='Milho'
    AND P.NOME='Doce Golden Bantam'INSERT INTO CULTURA (PARCELA_ID, PLANTA_ID, DATA_INICIAL, DATA_FINAL, QUANTIDADE, UNIDADES) VALUES ('101', V_ID_PLANTA, TIMESTAMP '2022-04-15 00:00:00', 'DATE '2022-08-21'') RETURNING ID INTO V_ID_CULTURA;
  SELECT
    P.ID INTO V_ID_PLANTA
  FROM
    PLANTA P
  ...
  WHERE
    TP.DESIGNACAO='Milho'
    AND P.NOME='Mas 24.C'INSERT INTO CULTURA (PARCELA_ID, PLANTA_ID, DATA_INICIAL, DATA_FINAL, QUANTIDADE, UNIDADES) VALUES ('103', V_ID_PLANTA, TIMESTAMP '2020-04-05 00:00:00', 'DATE '2020-08-20'') RETURNING ID INTO V_ID_CULTURA;
  SELECT
    P.ID INTO V_ID_PLANTA
  FROM
    PLANTA P
  ...
  WHERE
    TP.DESIGNACAO='Tremoco'
    AND P.NOME='Amarelo'INSERT INTO CULTURA (PARCELA_ID, PLANTA_ID, DATA_INICIAL, DATA_FINAL, QUANTIDADE, UNIDADES) VALUES ('103', V_ID_PLANTA, TIMESTAMP '2020-10-12 00:00:00', 'DATE '2021-03-15'') RETURNING ID INTO V_ID_CULTURA;
  SELECT
    P.ID INTO V_ID_PLANTA
  FROM
    PLANTA P
  ...
  WHERE
    TP.DESIGNACAO='Milho'
    AND P.NOME='Mas 24.C'INSERT INTO CULTURA (PARCELA_ID, PLANTA_ID, DATA_INICIAL, DATA_FINAL, QUANTIDADE, UNIDADES) VALUES ('103', V_ID_PLANTA, TIMESTAMP '2021-04-03 00:00:00', 'DATE '2021-08-25'') RETURNING ID INTO V_ID_CULTURA;
  SELECT
    P.ID INTO V_ID_PLANTA
  FROM
    PLANTA P
  ...
  WHERE
    TP.DESIGNACAO='Tremoco'
    AND P.NOME='Amarelo'INSERT INTO CULTURA (PARCELA_ID, PLANTA_ID, DATA_INICIAL, DATA_FINAL, QUANTIDADE, UNIDADES) VALUES ('103', V_ID_PLANTA, TIMESTAMP '2021-10-06 00:00:00', 'DATE '2022-03-19'') RETURNING ID INTO V_ID_CULTURA;
  SELECT
    P.ID INTO V_ID_PLANTA
  FROM
    PLANTA P
  ...
  WHERE
    TP.DESIGNACAO='Milho'
    AND P.NOME='Mas 24.C'INSERT INTO CULTURA (PARCELA_ID, PLANTA_ID, DATA_INICIAL, DATA_FINAL, QUANTIDADE, UNIDADES) VALUES ('103', V_ID_PLANTA, TIMESTAMP '2022-04-08 00:00:00', 'DATE '2022-08-18'') RETURNING ID INTO V_ID_CULTURA;
  SELECT
    P.ID INTO V_ID_PLANTA
  FROM
    PLANTA P
  ...
  WHERE
    TP.DESIGNACAO='Tremoco'
    AND P.NOME='Amarelo'INSERT INTO CULTURA (PARCELA_ID, PLANTA_ID, DATA_INICIAL, DATA_FINAL, QUANTIDADE, UNIDADES) VALUES ('103', V_ID_PLANTA, TIMESTAMP '2022-10-12 00:00:00', 'DATE '2023-03-20'') RETURNING ID INTO V_ID_CULTURA;
  SELECT
    P.ID INTO V_ID_PLANTA
  FROM
    PLANTA P
  ...
  WHERE
    ...
    AND P.NOME='Galega'INSERT INTO CULTURA (PARCELA_ID, PLANTA_ID, DATA_INICIAL, DATA_FINAL, QUANTIDADE, UNIDADES) VALUES ('102', V_ID_PLANTA, TIMESTAMP '2016-10-06 00:00:00', '''') RETURNING ID INTO V_ID_CULTURA;
  ...
  INSERT INTO PLANTACAO (
    ...
    WHERE
      TP.DESIGNACAO='Oliveira'
      AND P.NOME='Picual'INSERT INTO CULTURA (PARCELA_ID, PLANTA_ID, DATA_INICIAL, DATA_FINAL, QUANTIDADE, UNIDADES) VALUES ('102', V_ID_PLANTA, TIMESTAMP '2016-10-10 00:00:00', '''') RETURNING ID INTO V_ID_CULTURA;
  INSERT INTO OPERACAO (
    DATA,
    ESTADO
  ) VALUES (
  ...
  INSERT INTO PLANTACAO (
    ...
    WHERE
      ...
      AND P.NOME='Scarlet Nantes'INSERT INTO CULTURA (PARCELA_ID, PLANTA_ID, DATA_INICIAL, DATA_FINAL, QUANTIDADE, UNIDADES) VALUES ('106', V_ID_PLANTA, TIMESTAMP '2020-03-10 00:00:00', 'DATE '2020-05-15'') RETURNING ID INTO V_ID_CULTURA;
  SELECT
    P.ID INTO V_ID_PLANTA
  FROM
    PLANTA P
  ...
  WHERE
    TP.DESIGNACAO='Cenoura'
    AND P.NOME='Nelson Hybrid'INSERT INTO CULTURA (PARCELA_ID, PLANTA_ID, DATA_INICIAL, DATA_FINAL, QUANTIDADE, UNIDADES) VALUES ('106', V_ID_PLANTA, TIMESTAMP '2020-06-02 00:00:00', 'DATE '2020-09-08'') RETURNING ID INTO V_ID_CULTURA;
  SELECT
    P.ID INTO V_ID_PLANTA
  FROM
    PLANTA P
  ...
  WHERE
    TP.DESIGNACAO='Nabo'
    AND P.NOME='S. Cosme'INSERT INTO CULTURA (PARCELA_ID, PLANTA_ID, DATA_INICIAL, DATA_FINAL, QUANTIDADE, UNIDADES) VALUES ('106', V_ID_PLANTA, TIMESTAMP '2020-09-20 00:00:00', 'DATE '2021-01-10'') RETURNING ID INTO V_ID_CULTURA;
  SELECT
    P.ID INTO V_ID_PLANTA
  FROM
    PLANTA P
  ...
  WHERE
    TP.DESIGNACAO='Cenoura'
    AND P.NOME='Sugarsnax Hybrid'INSERT INTO CULTURA (PARCELA_ID, PLANTA_ID, DATA_INICIAL, DATA_FINAL, QUANTIDADE, UNIDADES) VALUES ('106', V_ID_PLANTA, TIMESTAMP '2021-03-10 00:00:00', 'DATE '2021-05-15'') RETURNING ID INTO V_ID_CULTURA;
  SELECT
    P.ID INTO V_ID_PLANTA
  FROM
    PLANTA P
  ...
  WHERE
    TP.DESIGNACAO='Cenoura'
    AND P.NOME='Danvers Half Long'INSERT INTO CULTURA (PARCELA_ID, PLANTA_ID, DATA_INICIAL, DATA_FINAL, QUANTIDADE, UNIDADES) VALUES ('106', V_ID_PLANTA, TIMESTAMP '2021-06-02 00:00:00', 'DATE '2021-09-08'') RETURNING ID INTO V_ID_CULTURA;
  SELECT
    P.ID INTO V_ID_PLANTA
  FROM
    PLANTA P
  ...
  WHERE
    TP.DESIGNACAO='Nabo'
    AND P.NOME='S. Cosme'INSERT INTO CULTURA (PARCELA_ID, PLANTA_ID, DATA_INICIAL, DATA_FINAL, QUANTIDADE, UNIDADES) VALUES ('106', V_ID_PLANTA, TIMESTAMP '2021-09-20 00:00:00', 'DATE '2022-01-10'') RETURNING ID INTO V_ID_CULTURA;
  SELECT
    P.ID INTO V_ID_PLANTA
  FROM
    PLANTA P
  ...
  WHERE
    TP.DESIGNACAO='Cenoura'
    AND P.NOME='Sugarsnax Hybrid'INSERT INTO CULTURA (PARCELA_ID, PLANTA_ID, DATA_INICIAL, DATA_FINAL, QUANTIDADE, UNIDADES) VALUES ('106', V_ID_PLANTA, TIMESTAMP '2022-03-06 00:00:00', 'DATE '2022-05-16'') RETURNING ID INTO V_ID_CULTURA;
  SELECT
    P.ID INTO V_ID_PLANTA
  FROM
    PLANTA P
  ...
  WHERE
    TP.DESIGNACAO='Cenoura'
    AND P.NOME='Nelson Hybrid'INSERT INTO CULTURA (PARCELA_ID, PLANTA_ID, DATA_INICIAL, DATA_FINAL, QUANTIDADE, UNIDADES) VALUES ('106', V_ID_PLANTA, TIMESTAMP '2022-05-30 00:00:00', 'DATE '2022-09-05'') RETURNING ID INTO V_ID_CULTURA;
  SELECT
    P.ID INTO V_ID_PLANTA
  FROM
    PLANTA P
  ...
  WHERE
    ...
    AND P.NOME='Senhora Conceicao'INSERT INTO CULTURA (PARCELA_ID, PLANTA_ID, DATA_INICIAL, DATA_FINAL, QUANTIDADE, UNIDADES) VALUES ('106', V_ID_PLANTA, TIMESTAMP '2022-09-20 00:00:00', 'DATE '2023-01-14'') RETURNING ID INTO V_ID_CULTURA;
  SELECT
    P.ID INTO V_ID_PLANTA
  FROM
    PLANTA P
  ...
  WHERE
    ...
    AND P.NOME='Jonagored'INSERT INTO CULTURA (PARCELA_ID, PLANTA_ID, DATA_INICIAL, DATA_FINAL, QUANTIDADE, UNIDADES) VALUES ('104', V_ID_PLANTA, TIMESTAMP '2017-01-07 00:00:00', '''') RETURNING ID INTO V_ID_CULTURA;
  INSERT INTO OPERACAO (
    DATA,
    ESTADO
  ) VALUES (
  ...
  INSERT INTO PLANTACAO (
    ...
    WHERE
      TP.DESIGNACAO='Macieira'
      AND P.NOME='Fuji'INSERT INTO CULTURA (PARCELA_ID, PLANTA_ID, DATA_INICIAL, DATA_FINAL, QUANTIDADE, UNIDADES) VALUES ('104', V_ID_PLANTA, TIMESTAMP '2017-01-08 00:00:00', '''') RETURNING ID INTO V_ID_CULTURA;
  INSERT INTO OPERACAO (
    DATA,
    ESTADO
  ) VALUES (
  ...
  INSERT INTO PLANTACAO (
    ...
    WHERE
      TP.DESIGNACAO='Macieira'
      AND P.NOME='Royal Gala'INSERT INTO CULTURA (PARCELA_ID, PLANTA_ID, DATA_INICIAL, DATA_FINAL, QUANTIDADE, UNIDADES) VALUES ('104', V_ID_PLANTA, TIMESTAMP '2017-01-08 00:00:00', '''') RETURNING ID INTO V_ID_CULTURA;
  INSERT INTO OPERACAO (
    DATA,
    ESTADO
  ) VALUES (
  ...
  INSERT INTO PLANTACAO (
    ...
    WHERE
      TP.DESIGNACAO='Macieira'
      AND P.NOME='Royal Gala'INSERT INTO CULTURA (PARCELA_ID, PLANTA_ID, DATA_INICIAL, DATA_FINAL, QUANTIDADE, UNIDADES) VALUES ('104', V_ID_PLANTA, TIMESTAMP '2018-12-10 00:00:00', '''') RETURNING ID INTO V_ID_CULTURA;
  INSERT INTO OPERACAO (
    DATA,
    ESTADO
  ) VALUES (
  ...
  INSERT INTO PLANTACAO (
    ...
    WHERE
      ...
      AND P.NOME='Dona Maria'INSERT INTO CULTURA (PARCELA_ID, PLANTA_ID, DATA_INICIAL, DATA_FINAL, QUANTIDADE, UNIDADES) VALUES ('107', V_ID_PLANTA, TIMESTAMP '2018-01-10 00:00:00', '''') RETURNING ID INTO V_ID_CULTURA;
  INSERT INTO OPERACAO (
    DATA,
    ESTADO
  ) VALUES (
  ...
  INSERT INTO PLANTACAO (
    ...
    WHERE
      TP.DESIGNACAO='Videira'
      AND P.NOME='Cardinal'INSERT INTO CULTURA (PARCELA_ID, PLANTA_ID, DATA_INICIAL, DATA_FINAL, QUANTIDADE, UNIDADES) VALUES ('107', V_ID_PLANTA, TIMESTAMP '2018-01-11 00:00:00', '''') RETURNING ID INTO V_ID_CULTURA;
  INSERT INTO OPERACAO (
    DATA,
    ESTADO
  ) VALUES (
